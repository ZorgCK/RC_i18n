...
public class ViewRegister extends VerticalLayout
{
	...
	public ViewRegister()
	{
		...
		final List<Locale> collect =
			Arrays.asList(Locale.getISOCountries()).parallelStream().map(c -> new Locale("", c))
				.collect(Collectors.toList());
		Collections.sort(collect, Comparator.comparing(Locale::getCountry));
		this.cboCountry.setItems(collect);
